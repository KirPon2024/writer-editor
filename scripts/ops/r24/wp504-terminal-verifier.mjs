...
const WP504_WORDING_SURFACE_EVALUATION_SHA = 'faef2f0813e4c8eb4b8703682e417aea72e627de';
const WP504_WORDING_SURFACE_EVALUATION_TREE = 'b223e12273e9e9c790241125cef9f883239cbb0e';
...
export function verifyWp504CandidateBoundSuccessor({ carrierRegistryEvaluationSha = WP504_CARRIER_REGISTRY_EVALUATION_SHA, wordingSurfaceEvaluationSha = WP504_WORDING_SURFACE_EVALUATION_SHA } = {}) {
  ...
  assert(wordingSuccessor.digest === successor.value.bindings.release01WordingSurfaceSuccessorDigest, 'E_WP504_V3_WORDING_SUCCESSOR');
  assert(wordingSuccessor.value.evaluationBase.sha === WP504_WORDING_SURFACE_EVALUATION_SHA && wordingSuccessor.value.evaluationBase.treeSha === WP504_WORDING_SURFACE_EVALUATION_TREE && wordingSurfaceEvaluationSha === WP504_WORDING_SURFACE_EVALUATION_SHA && gitTree(wordingSurfaceEvaluationSha) === WP504_WORDING_SURFACE_EVALUATION_TREE, 'E_WP504_V3_WORDING_EVALUATION_OBJECT', wordingSurfaceEvaluationSha);
  assert(wordingSuccessor.value.predecessorSuccessor.sha256 === gitObjectDigest(wordingSurfaceEvaluationSha, wordingSuccessor.value.predecessorSuccessor.path) && wordingSuccessor.value.surfaceOverrides.every((surface) => surface.sha256 === `sha256:${gitObjectDigest(wordingSurfaceEvaluationSha, surface.path)}`), 'E_WP504_V3_WORDING_SUCCESSOR');
