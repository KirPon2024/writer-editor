...
- deadlinePolicy: production defaults are wall timeout 1800000 ms, no-progress timeout 600000 ms, TERM grace 5000 ms, and KILL grace 5000 ms; tests inject smaller deterministic values; deadline expiry must terminate the owned process group and wait for exit plus cleanup proof
