...
test('E12 saturation ledger binds native UI physical limitation and keeps Word current', async () => {
  ...
  assert.match(program.v4ExecutionState.nextStage, /^EXECUTION_03_(A03_C02_NON_OVERLAP_TRACKED_REPLACEMENTS_RUNTIME_CONTOUR|A03_C03_ADJACENT_RANGE_NEGATIVE_ORACLE|A03_C04_MODERN_COMMENT_STATE_ONLY_IF_PHYSICAL_PASS)$/u);
