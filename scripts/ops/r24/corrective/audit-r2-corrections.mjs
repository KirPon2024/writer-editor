...
const PATHS = Object.freeze({
  ...
  carrierRegistry: `${ROOT}/AUDIT_R2_CARRIER_REGISTRY_V15.json`,
  predecessorCarrierRegistry: `${ROOT}/AUDIT_R2_CARRIER_REGISTRY_V14.json`,
...
export function checkCorrections(root = process.cwd()) {
  ...
  assert(predecessorCarrierRegistry.digest === '7ba08968e97ee07413aa307b8fa64a4a339704ee0627c8d2d4f04e56debba67a' && predecessorCarrierRegistry.value.schemaVersion === 'AUDIT_R2_CARRIER_REGISTRY_V14', 'E_CARRIER_REGISTRY_PREDECESSOR_DIGEST', predecessorCarrierRegistry.digest);
  ...
  assert(carrierRegistry.schemaVersion === 'AUDIT_R2_CARRIER_REGISTRY_V15' && carrierRegistry.baseSha === stage.value.baseSha && carrierRegistry.baseTreeSha === stage.value.treeSha, 'E_CARRIER_REGISTRY_BINDING', carrierRegistry.schemaVersion);
  assertExactJson(carrierRegistry.predecessor,{path:PATHS.predecessorCarrierRegistry,sha256:predecessorCarrierRegistry.digest,status:'SUPERSEDED_BY_APPEND_ONLY_WP503_RELEASE01_WORDING_SURFACE_SUCCESSOR'},'E_CARRIER_REGISTRY_PREDECESSOR','binding');
  ...
  assertExactJson(carrierRegistry.successorScope,{reason:'CURRENT_REPOSITORY_RELEASE01_WORDING_SURFACES_REFRESHED_BY_ADMITTED_WP503_APPEND_ONLY_SUCCESSOR',replacementPaths:['.github/workflows/oss-policy.yml',`${ROOT}/C1B_TEST_INVENTORY_V1.json`,'scripts/ops/r24/corrective/audit-r2-corrections.mjs','scripts/ops/r24/wp503-terminal-verifier.mjs','test/contracts/r24-audit-r2-corrections.contract.test.mjs','test/contracts/r24-wp503-terminal-carriers.contract.test.mjs','test/contracts/rtk-release01-terminal-claims.contract.test.js'],addedPaths:[`${ROOT}/AUDIT_R2_CARRIER_REGISTRY_V15.json`,`${ROOT}/WP503_GOVERNANCE_CHANGE_APPROVALS_V2.json`,`${ROOT}/WP503_LOCAL_RTK_FAILURE_V1.json`,`${ROOT}/WP503_MAIN_PRODUCT_OWNER_AUTHORITY_AMENDMENT_V5.json`,`${ROOT}/WP503_MAIN_PRODUCT_STAGE_ADMISSION_ATTESTATION_V5.json`,`${ROOT}/WP503_MAIN_PRODUCT_STAGE_INSTANCE_V5.json`,`${ROOT}/WP503_RELEASE01_WORDING_SURFACE_SUCCESSOR_V1.json`,`${ROOT}/WP503_TERMINAL_SUPPLEMENT_V1.json`],removedPaths:[]},'E_CARRIER_REGISTRY_SUCCESSOR_SCOPE','scope');
