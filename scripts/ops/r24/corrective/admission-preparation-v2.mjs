...
export function runPreparation(argv){
  ...
  const root=fs.realpathSync(args['repo-root']),verifier=fs.realpathSync(path.join(root,'scripts/ops/r24/corrective/stage-admission-verifier-v3.mjs'));
