...
function verify(values) {
  assert.equal(h(bytes(paths.authority)), '67406d2c744d866c12482341f894dc524ef46667ac1a752609587f59ed178d8b');
  assert.equal(h(bytes(paths.instance)), '0e983b9d21d22d5855bc5549d3b1978f2a507b0075169590fbc7767da52e4640');
  assert.equal(h(bytes(paths.admission)), '1d8b6744e8f5341e8348550b284827b05b6fdc1d3bd9ef735fb3b554038f2efb');
  assert.equal(values.admission.writeSetDigest, '42c65596d1862e97a5eb8a98c6a5a85b5d33898cca48684acc53ecf2b00d45fd');
