...
test('V4 E09 updates capability profile and program state without runtime changes', () => {
  ...
  assert.ok([
    'STRUCTURAL_DIAGNOSTIC_BLOCKING_WITH_TYPED_LIMITATIONS',
    'STRUCTURAL_DIAGNOSTIC_LANE_TERMINAL_TYPED_LIMITATION_BOUND',
