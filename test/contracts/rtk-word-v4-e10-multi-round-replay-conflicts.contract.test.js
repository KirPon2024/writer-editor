...
test('V4 E10 updates capability profile and program state without runtime changes', () => {
  ...
  assert.ok([
    'REPLAY_STALE_CONFLICT_GUARD_DIAGNOSTICS_WITH_TYPED_LIMITATIONS',
    'REPLAY_STALE_CONFLICT_GUARD_TERMINAL_RECONCILED_WITH_PRODUCT_REPLAY_EVIDENCE',
