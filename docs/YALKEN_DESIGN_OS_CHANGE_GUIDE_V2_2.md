...
TRUTH_ORDER_03: COREX.md_RESOLVER_AND_CURRENT_COREX.v2.md
TRUTH_ORDER_04: BIBLE.md
TRUTH_ORDER_05: ARCHITECTURE_ONE_PAGE.md_AND_PRODUCT_GLOSSARY.md
TRUTH_ORDER_06: README.md
TRUTH_ORDER_07: CONTEXT.md
TRUTH_ORDER_08: PROCESS.md
TRUTH_ORDER_09: HANDOFF.md
...
CURRENT_MAP_STATUS: HISTORICAL_SNAPSHOT_REFERENCE_NOT_LIVE_PREFLIGHT_BINDING
...
CURRENT_MAP_RULE_02: REBIND_ONLY_BEFORE_USING_THESE_ROWS_AS_CURRENT_EVIDENCE
...
FRESHNESS_RULE_04: IF_TASK_RELIES_ON_THIS_MAP_AND_REMOTE_DIFFERS_RECONCILE_OR_REBIND_MAP_CLAIMS
FRESHNESS_RULE_05: VERIFIED_AT_UTC_IS_METADATA_NOT_SUBSTITUTE_FOR_REBIND
```

Старый snapshot не блокирует несвязанную работу сам по себе. Он запрещает
только выдавать содержащиеся в нём status rows за текущие доказательства без
reconcile или rebind. Для любого write-contour всё равно отдельно проверяются
фактические HEAD, remote HEAD и чистота выбранного worktree.
