...
const PATHS = Object.freeze({
  ...
  carrierRegistry: `${ROOT}/AUDIT_R2_CARRIER_REGISTRY_V19.json`,
  predecessorCarrierRegistry: `${ROOT}/AUDIT_R2_CARRIER_REGISTRY_V18.json`,
...
export function checkCorrections(root = process.cwd()) {
  ...
  assert(predecessorCarrierRegistry.digest === '6ba8627ca8c56dba1490c092c6a025494180692cb2844e95135615feb35415e1' && predecessorCarrierRegistry.value.schemaVersion === 'AUDIT_R2_CARRIER_REGISTRY_V18', 'E_CARRIER_REGISTRY_PREDECESSOR_DIGEST', predecessorCarrierRegistry.digest);
  ...
  assert(carrierRegistry.schemaVersion === 'AUDIT_R2_CARRIER_REGISTRY_V19' && carrierRegistry.baseSha === stage.value.baseSha && carrierRegistry.baseTreeSha === stage.value.treeSha, 'E_CARRIER_REGISTRY_BINDING', carrierRegistry.schemaVersion);
  assertExactJson(carrierRegistry.predecessor,{path:PATHS.predecessorCarrierRegistry,sha256:predecessorCarrierRegistry.digest,status:'SUPERSEDED_BY_APPEND_ONLY_WP503_SELECTION_PROVENANCE_SUCCESSOR'},'E_CARRIER_REGISTRY_PREDECESSOR','binding');
  ...
  assertExactJson(carrierRegistry.successorScope,{reason:'SELECTION_CREATION_PROVENANCE_BOUND_BY_ADMITTED_WP503_APPEND_ONLY_SUCCESSOR',replacementPaths:['.github/workflows/oss-policy.yml',`${ROOT}/C1B_TEST_INVENTORY_V1.json`,'scripts/ops/r24/corrective/audit-r2-corrections.mjs','scripts/ops/r24/corrective/post-audit-certification-set.mjs','scripts/ops/r24/wp503-terminal-verifier.mjs','test/contracts/r24-audit-r2-corrections.contract.test.mjs','test/contracts/r24-post-audit-certification-set.contract.test.mjs','test/contracts/r24-wp503-terminal-carriers.contract.test.mjs'],reboundExistingPaths:[],addedPaths:[`${ROOT}/AUDIT_R2_CARRIER_REGISTRY_V19.json`,`${ROOT}/WP503_GOVERNANCE_CHANGE_APPROVALS_V7.json`,`${ROOT}/WP503_MAIN_PRODUCT_OWNER_AUTHORITY_AMENDMENT_V10.json`,`${ROOT}/WP503_MAIN_PRODUCT_STAGE_ADMISSION_ATTESTATION_V10.json`,`${ROOT}/WP503_MAIN_PRODUCT_STAGE_INSTANCE_V10.json`,`${ROOT}/WP503_SELECTION_PROVENANCE_FAILURE_V1.json`,`${ROOT}/WP503_SELECTION_PROVENANCE_SUCCESSOR_V1.json`,`${ROOT}/WP503_TERMINAL_SUPPLEMENT_V6.json`],removedPaths:[]},'E_CARRIER_REGISTRY_SUCCESSOR_SCOPE','scope');
