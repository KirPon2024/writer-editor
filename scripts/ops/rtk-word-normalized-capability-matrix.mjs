...
const NORMALIZED_OVERLAY = {
  ...
  'rtk.word.v4.effectiveFormattingDiagnostics': {
    ...
    reasonCode: 'RTK_NORM_FORMATTING_APPLY_TYPED_LIMITATION_BOUND',
    requiredNextContour: 'NONE_FORMATTING_TYPED_LIMITATION_BOUND',
    blocksWordSaturation: false,
  },
  'rtk.word.v4.typedStructuralDiagnostics': {
    ...
    reasonCode: 'RTK_NORM_STRUCTURAL_APPLY_TYPED_LIMITATION_BOUND',
    requiredNextContour: 'NONE_STRUCTURAL_TYPED_LIMITATION_BOUND',
    blocksWordSaturation: false,
  },
  ...
  'rtk.word.v4.modernCommentStateReadbackGate': {
    ...
    reasonCode: 'RTK_NORM_RESOLVE_REOPEN_TYPED_LIMITATION_BOUND',
    requiredNextContour: 'NONE_RESOLVE_REOPEN_TYPED_LIMITATION_BOUND',
    blocksWordSaturation: false,
  },
