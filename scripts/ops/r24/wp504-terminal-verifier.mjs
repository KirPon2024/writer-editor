...
const P3 = Object.freeze({
  authority: `${C}/WP504_MAIN_PRODUCT_OWNER_AUTHORITY_AMENDMENT_V9.json`,
  instance: `${C}/WP504_MAIN_PRODUCT_STAGE_INSTANCE_V9.json`,
  admission: `${C}/WP504_MAIN_PRODUCT_STAGE_ADMISSION_ATTESTATION_V9.json`,
...
export function verifyWp504CandidateBoundSuccessor() {
  ...
  assert(instance.value.baseSha === 'c0b32b36fe0e46b26e0278c8df4f07ffbb6450e0' && instance.value.treeSha === '77f2b4b354e526820d9d47f8c4449cfbc60644fa' && instance.value.model === 'gpt-5.6-sol' && instance.value.reasoningEffort === 'xhigh', 'E_WP504_V3_IDENTITY');
  ...
  assert(failure.digest === successor.value.bindings.failureDigest && predecessor.digest === successor.value.bindings.wp503ExternalClosureV2Digest && successor.value.evaluationPolicy.completeWp504AdmissionDenominator === 5 && successor.value.evaluationPolicy.arbitraryDescendantDeltaAccepted === false, 'E_WP504_V3_SUCCESSOR');
