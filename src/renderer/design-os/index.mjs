...
export {
  DESIGN_OS_FORM_CONFIGURATION_LIFECYCLES,
  DESIGN_OS_FORM_CONFIGURATION_MAX_BYTES,
  DESIGN_OS_FORM_CONFIGURATION_MAX_DEPTH,
  DESIGN_OS_FORM_CONFIGURATION_MAX_ENTRIES,
  DESIGN_OS_FORM_CONFIGURATION_MAX_REVISION,
  DESIGN_OS_FORM_CONFIGURATION_SCHEMA_VERSION,
  DESIGN_OS_FORM_CONFIGURATION_SNAPSHOT_SCHEMA_VERSION,
  DesignOsFormConfigurationController,
  DesignOsFormConfigurationError,
  createDesignOsFormConfigurationController,
  validateDesignOsFormConfiguration,
} from './designOsFormConfiguration.mjs';
