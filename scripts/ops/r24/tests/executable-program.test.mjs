...
test('scheduler selection receipt is bound to the real full graph rather than a fixture', () => {
  ...
  assert.equal(receipt.selectedId, 'WP-302_EDITORIAL_SHEET');
  ...
  assert.deepEqual(receipt.readySet, ["WP-302_EDITORIAL_SHEET"]);
});
