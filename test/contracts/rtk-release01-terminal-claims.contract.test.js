...
const WORDING_PREDECESSOR_PATH = path.join(REPO_ROOT, 'docs', 'OPS', 'R24', 'CORRECTIVE', 'WP800_RELEASE01_WORDING_SURFACE_SUCCESSOR_V1.json');
const WORDING_SUCCESSOR_PATH = path.join(REPO_ROOT, 'docs', 'OPS', 'R24', 'CORRECTIVE', 'WP801_RELEASE01_WORDING_SURFACE_SUCCESSOR_V1.json');
