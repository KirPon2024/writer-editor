...
function buildTruthTable() {
  ...
  return {
    ...
    FREEZE_PROFILE_DOC_ALIGNMENT_OK: freezeRollups.FREEZE_PROFILE_DOC_ALIGNMENT_OK,
...
function emitMd(table) {
  ...
  console.log(`FREEZE_PROFILE_DOC_ALIGNMENT_OK=${table.FREEZE_PROFILE_DOC_ALIGNMENT_OK}`);
