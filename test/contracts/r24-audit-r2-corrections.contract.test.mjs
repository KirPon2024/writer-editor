...
test('the append-only audit-R2 carrier chain passes the static exact-byte check',()=>{
  ...
  assert.equal(result.schemaVersion,'AUDIT_R2_CORRECTION_STATIC_CHECK_V19');
  assert.equal(result.predecessorCarrierRegistryDigest,'6ba8627ca8c56dba1490c092c6a025494180692cb2844e95135615feb35415e1');
...
test('audit-R2 registry successor binds distinct source roles and the admitted WP503 selection-provenance repair',()=>{
  ...
  assert.equal(value.predecessor.sha256,'6ba8627ca8c56dba1490c092c6a025494180692cb2844e95135615feb35415e1');
  assert.equal(value.predecessor.status,'SUPERSEDED_BY_APPEND_ONLY_WP503_SELECTION_PROVENANCE_SUCCESSOR');
  ...
  assert.deepEqual(value.successorScope.addedPaths,['docs/OPS/R24/CORRECTIVE/AUDIT_R2_CARRIER_REGISTRY_V19.json','docs/OPS/R24/CORRECTIVE/WP503_GOVERNANCE_CHANGE_APPROVALS_V7.json','docs/OPS/R24/CORRECTIVE/WP503_MAIN_PRODUCT_OWNER_AUTHORITY_AMENDMENT_V10.json','docs/OPS/R24/CORRECTIVE/WP503_MAIN_PRODUCT_STAGE_ADMISSION_ATTESTATION_V10.json','docs/OPS/R24/CORRECTIVE/WP503_MAIN_PRODUCT_STAGE_INSTANCE_V10.json','docs/OPS/R24/CORRECTIVE/WP503_SELECTION_PROVENANCE_FAILURE_V1.json','docs/OPS/R24/CORRECTIVE/WP503_SELECTION_PROVENANCE_SUCCESSOR_V1.json','docs/OPS/R24/CORRECTIVE/WP503_TERMINAL_SUPPLEMENT_V6.json']);
