...
export function verifyWp702Wp504HistoricalSurfacePostEvaluationException({candidateSha='HEAD',git=defaultGit}={}){
  ...
  assert(h(fs.readFileSync(expectation.wp504VerifierPath))===expectation.wp504VerifierDigest,'E_WP702_WP504_HISTORICAL_SURFACE_ARTIFACT_BINDING',expectation.wp504VerifierPath);
