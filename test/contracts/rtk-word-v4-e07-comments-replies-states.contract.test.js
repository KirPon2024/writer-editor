...
test('V4 E07 updates capability profile and program state without runtime mutation authority', () => {
  ...
  assert.equal([
    'VISIBLE_ANCHORED_COMMENT_SHADOW_ANALYSIS_WITH_TYPED_LIMITATIONS',
    'VISIBLE_COMMENT_SHADOW_ANALYSIS_WITH_REPLY_TYPED_LIMITATION_PRESERVED',
  ].includes(cell.currentCapability), true);
