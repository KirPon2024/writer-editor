...
export const EXACT_HEAD = '9c095ea89425e52da669ad5bfe9b2bfc727d7db6';
...
export function runC1HostileCorpus() {
  ...
  const cases = [
    ...
    ['word-status-pass', (r) => { r.physicalEvidence.resultStatus.wordStatus = 'PASS'; }, 'WORD_STATUS_MUST_REMAIN_FAIL'],
