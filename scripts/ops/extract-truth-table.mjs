...
function buildTruthTable() {
  ...
  return {
    ...
    COMMAND_SURFACE_SINGLE_ENTRY_OK: freezeRollups.COMMAND_SURFACE_SINGLE_ENTRY_OK,
    COMMAND_SURFACE_BYPASS_NEGATIVE_TESTS_OK: freezeRollups.COMMAND_SURFACE_BYPASS_NEGATIVE_TESTS_OK,
    PATH_BOUNDARY_GUARD_OK: freezeRollups.PATH_BOUNDARY_GUARD_OK,
    DEPENDENCY_REMEDIATION_POLICY_OK: freezeRollups.DEPENDENCY_REMEDIATION_POLICY_OK,
    PRE_UI_OPS_CONTOUR_RECORD_VALID_OK: freezeRollups.PRE_UI_OPS_CONTOUR_RECORD_VALID_OK,
    PRE_UI_OPS_CONTOUR_CLOSED_OK: freezeRollups.PRE_UI_OPS_CONTOUR_CLOSED_OK,
    ...
    DERIVED_VIEWS_PURE_OK: freezeRollups.DERIVED_VIEWS_PURE_OK,
    DERIVED_VIEWS_DETERMINISTIC_OK: freezeRollups.DERIVED_VIEWS_DETERMINISTIC_OK,
    DERIVED_VIEWS_NO_SECOND_SOT_OK: freezeRollups.DERIVED_VIEWS_NO_SECOND_SOT_OK,
    DERIVED_VIEWS_INVALIDATION_KEY_OK: freezeRollups.DERIVED_VIEWS_INVALIDATION_KEY_OK,
    DERIVED_VIEWS_INFRA_OK: freezeRollups.DERIVED_VIEWS_INFRA_OK,
    MINDMAP_DERIVED_GRAPH_DETERMINISTIC_OK: freezeRollups.MINDMAP_DERIVED_GRAPH_DETERMINISTIC_OK,
    MINDMAP_DERIVED_GRAPH_HASH_OK: freezeRollups.MINDMAP_DERIVED_GRAPH_HASH_OK,
    MINDMAP_DERIVED_GRAPH_INVALIDATION_KEY_OK: freezeRollups.MINDMAP_DERIVED_GRAPH_INVALIDATION_KEY_OK,
    MINDMAP_DERIVED_GRAPH_NO_SECOND_SOT_OK: freezeRollups.MINDMAP_DERIVED_GRAPH_NO_SECOND_SOT_OK,
    MINDMAP_DERIVED_GRAPH_OK: freezeRollups.MINDMAP_DERIVED_GRAPH_OK,
    XPLAT_COST_GUARANTEE_OK: freezeRollups.XPLAT_COST_GUARANTEE_OK,
    GOVERNANCE_STRICT_OK: freezeRollups.GOVERNANCE_STRICT_OK,
    GOVERNANCE_STATE_VALID: freezeRollups.GOVERNANCE_STATE_VALID,
    STRATEGY_PROGRESS_VALID: freezeRollups.STRATEGY_PROGRESS_VALID,
    ...
    COLLAB_EVENTLOG_SCHEMA_OK: freezeRollups.COLLAB_EVENTLOG_SCHEMA_OK,
    COLLAB_EVENTLOG_APPEND_ONLY_OK: freezeRollups.COLLAB_EVENTLOG_APPEND_ONLY_OK,
    COLLAB_EVENTLOG_REPLAY_DETERMINISTIC_OK: freezeRollups.COLLAB_EVENTLOG_REPLAY_DETERMINISTIC_OK,
    COLLAB_EVENTLOG_IDEMPOTENCY_OK: freezeRollups.COLLAB_EVENTLOG_IDEMPOTENCY_OK,
    COLLAB_EVENTLOG_OK: freezeRollups.COLLAB_EVENTLOG_OK,
    COLLAB_APPLY_PIPELINE_PURE_OK: freezeRollups.COLLAB_APPLY_PIPELINE_PURE_OK,
    COLLAB_APPLY_PIPELINE_DETERMINISTIC_OK: freezeRollups.COLLAB_APPLY_PIPELINE_DETERMINISTIC_OK,
    COLLAB_APPLY_PIPELINE_TYPED_ERRORS_OK: freezeRollups.COLLAB_APPLY_PIPELINE_TYPED_ERRORS_OK,
    COLLAB_APPLY_PIPELINE_OK: freezeRollups.COLLAB_APPLY_PIPELINE_OK,
    COLLAB_CAUSAL_QUEUE_READINESS_OK: freezeRollups.COLLAB_CAUSAL_QUEUE_READINESS_OK,
    ...
    XPLAT_CONTRACT_MACOS_SIGNING_READY_OK: freezeRollups.XPLAT_CONTRACT_MACOS_SIGNING_READY_OK,
    RELEASE_ARTIFACT_SOURCES_OK: freezeRollups.RELEASE_ARTIFACT_SOURCES_OK,
    THIRD_PARTY_NOTICES_READINESS_OK: freezeRollups.THIRD_PARTY_NOTICES_READINESS_OK,
    TOKEN_SOURCE_CONFLICT_OK: freezeRollups.TOKEN_SOURCE_CONFLICT_OK,
    checks: [
      {
        id: 'REMOTE_BINDING',
        expected: true,
...
function emitMd(table) {
  ...
  console.log(`COMMAND_SURFACE_SINGLE_ENTRY_OK=${table.COMMAND_SURFACE_SINGLE_ENTRY_OK}`);
  console.log(`COMMAND_SURFACE_BYPASS_NEGATIVE_TESTS_OK=${table.COMMAND_SURFACE_BYPASS_NEGATIVE_TESTS_OK}`);
  console.log(`PATH_BOUNDARY_GUARD_OK=${table.PATH_BOUNDARY_GUARD_OK}`);
  console.log(`DEPENDENCY_REMEDIATION_POLICY_OK=${table.DEPENDENCY_REMEDIATION_POLICY_OK}`);
  console.log(`PRE_UI_OPS_CONTOUR_RECORD_VALID_OK=${table.PRE_UI_OPS_CONTOUR_RECORD_VALID_OK}`);
  console.log(`PRE_UI_OPS_CONTOUR_CLOSED_OK=${table.PRE_UI_OPS_CONTOUR_CLOSED_OK}`);
  ...
  console.log(`DERIVED_VIEWS_PURE_OK=${table.DERIVED_VIEWS_PURE_OK}`);
  console.log(`DERIVED_VIEWS_DETERMINISTIC_OK=${table.DERIVED_VIEWS_DETERMINISTIC_OK}`);
  console.log(`DERIVED_VIEWS_NO_SECOND_SOT_OK=${table.DERIVED_VIEWS_NO_SECOND_SOT_OK}`);
  console.log(`DERIVED_VIEWS_INVALIDATION_KEY_OK=${table.DERIVED_VIEWS_INVALIDATION_KEY_OK}`);
  console.log(`DERIVED_VIEWS_INFRA_OK=${table.DERIVED_VIEWS_INFRA_OK}`);
  console.log(`MINDMAP_DERIVED_GRAPH_DETERMINISTIC_OK=${table.MINDMAP_DERIVED_GRAPH_DETERMINISTIC_OK}`);
  console.log(`MINDMAP_DERIVED_GRAPH_HASH_OK=${table.MINDMAP_DERIVED_GRAPH_HASH_OK}`);
  console.log(`MINDMAP_DERIVED_GRAPH_INVALIDATION_KEY_OK=${table.MINDMAP_DERIVED_GRAPH_INVALIDATION_KEY_OK}`);
  console.log(`MINDMAP_DERIVED_GRAPH_NO_SECOND_SOT_OK=${table.MINDMAP_DERIVED_GRAPH_NO_SECOND_SOT_OK}`);
  console.log(`MINDMAP_DERIVED_GRAPH_OK=${table.MINDMAP_DERIVED_GRAPH_OK}`);
  ...
  console.log(`GOVERNANCE_STATE_VALID=${table.GOVERNANCE_STATE_VALID}`);
  console.log(`STRATEGY_PROGRESS_VALID=${table.STRATEGY_PROGRESS_VALID}`);
  ...
  console.log(`COLLAB_EVENTLOG_SCHEMA_OK=${table.COLLAB_EVENTLOG_SCHEMA_OK}`);
  console.log(`COLLAB_EVENTLOG_APPEND_ONLY_OK=${table.COLLAB_EVENTLOG_APPEND_ONLY_OK}`);
  console.log(`COLLAB_EVENTLOG_REPLAY_DETERMINISTIC_OK=${table.COLLAB_EVENTLOG_REPLAY_DETERMINISTIC_OK}`);
  console.log(`COLLAB_EVENTLOG_IDEMPOTENCY_OK=${table.COLLAB_EVENTLOG_IDEMPOTENCY_OK}`);
  console.log(`COLLAB_EVENTLOG_OK=${table.COLLAB_EVENTLOG_OK}`);
  console.log(`COLLAB_APPLY_PIPELINE_PURE_OK=${table.COLLAB_APPLY_PIPELINE_PURE_OK}`);
  console.log(`COLLAB_APPLY_PIPELINE_DETERMINISTIC_OK=${table.COLLAB_APPLY_PIPELINE_DETERMINISTIC_OK}`);
  console.log(`COLLAB_APPLY_PIPELINE_TYPED_ERRORS_OK=${table.COLLAB_APPLY_PIPELINE_TYPED_ERRORS_OK}`);
  console.log(`COLLAB_APPLY_PIPELINE_OK=${table.COLLAB_APPLY_PIPELINE_OK}`);
  console.log(`COLLAB_CAUSAL_QUEUE_READINESS_OK=${table.COLLAB_CAUSAL_QUEUE_READINESS_OK}`);
  ...
  console.log(`XPLAT_CONTRACT_MACOS_SIGNING_READY_OK=${table.XPLAT_CONTRACT_MACOS_SIGNING_READY_OK}`);
  console.log(`RELEASE_ARTIFACT_SOURCES_OK=${table.RELEASE_ARTIFACT_SOURCES_OK}`);
  console.log(`THIRD_PARTY_NOTICES_READINESS_OK=${table.THIRD_PARTY_NOTICES_READINESS_OK}`);
  console.log(`TOKEN_SOURCE_CONFLICT_OK=${table.TOKEN_SOURCE_CONFLICT_OK}`);
}
